...
<section class="accounts">
   ...
   <div class="box">
      ...
      <a href="users_accounts.php?delete=<?= $fetch_accounts['id']; ?>" onclick="return confirm('Supprimer ce compte ?')" class="delete-btn">Supprimer</a>
   </div>
   <?php
         }
      }else{
         echo '<p class="empty">Pas de comptes disponibles !</p>';
      }
   ?>
