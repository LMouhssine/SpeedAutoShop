...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="password" name="old_pass" placeholder="Ancien mot de passe" maxlength="20"  class="box" oninput="this.value = this.value.replace(/\s/g, '')">
      <input type="password" name="new_pass" placeholder="Nouveau mot de passe" maxlength="20"  class="box" oninput="this.value = this.value.replace(/\s/g, '')">
