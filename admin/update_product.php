...
<section class="update-product">
   ...
   <h1 class="heading">Mise à jour du produit</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <span>Mettre à jour l'image 1</span>
      <input type="file" name="image_01" accept="image/jpg, image/jpeg, image/png, image/webp" class="box">
      <span>Mettre à jour l'image 2</span>
      <input type="file" name="image_02" accept="image/jpg, image/jpeg, image/png, image/webp" class="box">
      <span>Mettre à jour l'image 3</span>
      <input type="file" name="image_03" accept="image/jpg, image/jpeg, image/png, image/webp" class="box">
      <div class="flex-btn">
         <input type="submit" name="update" class="btn" value="Mettre à jour">
         <a href="products.php" class="option-btn">Annuler</a>
      </div>
   </form>
